...
class StackCups(Task):
    ...
    def init_episode(self, index: int) -> List[str]:
        ...
        self.cup2_visual.set_color([0.0, 0.0, 0.0])
        self.cup1_visual.set_color([1.0, 0.0, 0.0])
        self.cup3_visaul.set_color([0.0, 0.0, 1.0])
        self.block.set_color([0.0, 1.0, 0.0])
        ...
        # self.boundary.sample(self.block, min_distance=0.05,
        #                      min_rotation=(0, 0, 0), max_rotation=(0, 0, 0))
