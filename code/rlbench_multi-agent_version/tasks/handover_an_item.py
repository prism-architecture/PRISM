...
class HandoverAnItem(Task):

    def init_task(self) -> None:
        self.blocks_stacked = 0
        self.block_0 = Shape('block_0')
     
        # self.target_blocks = []
        # self.target_blocks.append(self.block_0)
        # self.target_blocks.append(self.block_1)
        # self.target_blocks.append(self.block_2)
        # self.target_blocks.append(self.block_3)
        ...
        self.register_graspable_objects([self.block_0])
    ...
    def init_episode(self, index: int) -> List[str]:
        ...
        self.block_0.set_color([1, 0, 0]) # red
