...
from rlbench.tasks.bimanual_dual_push_buttons import BimanualDualPushButtons
from rlbench.tasks.bimanual_put_item_in_drawer import BimanualPutItemInDrawer
from rlbench.tasks.handover_an_item import HandoverAnItem
from rlbench.tasks.handover_item import HandoverItem
from rlbench.tasks.bimanual_straighten_rope import BimanualStraightenRope
...
from rlbench.tasks.sort_items_in_cups import SortItemsInCups
from rlbench.tasks.bimanual_pick_plate import BimanualPickPlate
...
from rlbench.tasks.stack_blocks_v2 import StackBlocksV2
from rlbench.tasks.experiment_setup import ExperimentSetup
from rlbench.tasks.stack_blocks_v3 import StackBlocksV3
from rlbench.tasks.stack_blocks_v5 import StackBlocksV5
...
from rlbench.tasks.bimanual_straighten_rope import BimanualStraightenRope
from rlbench.tasks.bimanual_lift_ball import BimanualLiftBall
from rlbench.tasks.bimanual_handover_item_easy import BimanualHandoverItemEasy
from rlbench.tasks.bimanual_sweep_to_dustpan import BimanualSweepToDustpan
from rlbench.tasks.coordinated_lift_stick import CoordinatedLiftStick
from rlbench.tasks.bimanual_lift_tray import BimanualLiftTray
from rlbench.tasks.coordinated_close_jar import CoordinatedCloseJar
from rlbench.tasks.bimanual_push_box import BimanualPushBox
