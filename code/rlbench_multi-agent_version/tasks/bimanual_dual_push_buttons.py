...
class BimanualDualPushButtons(Task):
    ...
    def init_episode(self, index: int) -> List[str]:
        ...
        self.target_buttons[0].set_color([0.0, 1.0, 0.0])
        self.target_buttons[1].set_color([0.0, 0.0, 1.0])
        self.target_buttons[2].set_color([1.0, 1.0, 0.0])
