...
class LoadedTask(object):
    ...
    def __init__(self, pr: PyRep, scene: Scene, robot: Robot, robot2: Robot = None):
        self.pr = pr
        self.scene = scene
        self.robot = robot
        if robot2:
    ...
    def _create_python_file(self, task_file: str):
        ...
        new_file_path = join(CURRENT_DIR, '/home/sujan/anaconda3/envs/voxposer-env/lib/python3.9/site-packages/rlbench/tasks', task_file)
    ...
    def save_task(self):
        ttm_path = join(CURRENT_DIR, '/home/sujan/anaconda3/envs/voxposer-env/lib/python3.9/site-packages/rlbench/task_ttms',
    ...
    def rename(self):
        ...
        old_file_path = join(CURRENT_DIR, '/home/sujan/anaconda3/envs/voxposer-env/lib/python3.9/site-packages/rlbench/tasks', self.task_file)
        ...
        new_file_path = join(CURRENT_DIR, '/home/sujan/anaconda3/envs/voxposer-env/lib/python3.9/site-packages/rlbench/tasks', python_file)
        os.rename(old_file_path, new_file_path)

        # Rename .ttt
        old_ttm_path = join(CURRENT_DIR, '/home/sujan/anaconda3/envs/voxposer-env/lib/python3.9/site-packages/rlbench/task_ttms',
                        self.task_file.replace('.py', '.ttm'))
        new_ttm_path = join(CURRENT_DIR, '/home/sujan/anaconda3/envs/voxposer-env/lib/python3.9/site-packages/rlbench/task_ttms',
    ...
    def duplicate_task(self):
        ...
        old_file_path = join(CURRENT_DIR, '/home/sujan/anaconda3/envs/voxposer-env/lib/python3.9/site-packages/rlbench/tasks', self.task_file)
        old_class_name = self._file_to_class_name(self.task_file)
        new_file_path = join(CURRENT_DIR, '/home/sujan/anaconda3/envs/voxposer-env/lib/python3.9/site-packages/rlbench/tasks', new_python_file)
        new_class_name = self._file_to_class_name(name)
...
if __name__ == '__main__':
    ...
    pr = PyRep()
    ttt_file = join('/home/sujan/anaconda3/envs/voxposer-env/lib/python3.9/site-packages/rlbench', TTT_FILE)
    pr.launch(ttt_file, responsive_ui=True)
    pr.step_ui()

    robot = Robot(Panda(), PandaGripper())
    robot_2 = Robot(Panda(), PandaGripper())
    ...
    scene = Scene(pr, robot, robot_2, obs_config)
    loaded_task = LoadedTask(pr, scene, robot, robot_2)
