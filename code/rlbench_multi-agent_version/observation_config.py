...
class ObservationConfig(object):
    def __init__(self,
                 ...
                 overhead_camera_0: CameraConfig = None,
                 wrist_camera: CameraConfig = None,
                 front_camera: CameraConfig = None,
                 front_camera_0: CameraConfig = None,
                 ...
                 joint_velocities_2=True,
                 joint_velocities_noise_2: NoiseModel=Identity(),
                 joint_positions_2=True,
                 joint_positions_noise_2: NoiseModel=Identity(),
                 joint_forces_2=True,
                 joint_forces_noise_2: NoiseModel=Identity(),
                 gripper_open_2=True,
                 gripper_pose_2=True,
                 gripper_matrix_2=False,
                 gripper_joint_positions_2=False,
                 gripper_touch_forces_2=False,
                 record_gripper_closing_2=False,
        ...
        self.overhead_camera_0 = (
            CameraConfig() if overhead_camera_0 is None
            else overhead_camera_0)
        ...
        self.front_camera_0 = (
            CameraConfig() if front_camera_0 is None
            else front_camera_0)
        ...
        self.joint_velocities_noise_2 = joint_velocities_noise_2
        self.joint_positions_2 = joint_positions_2
        self.joint_positions_noise_2 = joint_positions_noise_2
        self.joint_forces_2 = joint_forces_2
        self.joint_forces_noise_2 = joint_forces_noise_2
        ...
        self.record_gripper_closing_2 = record_gripper_closing_2
    ...
    def set_all_high_dim(self, value: bool):
        ...
        self.overhead_camera_0.set_all(value)
        self.wrist_camera.set_all(value)
        self.front_camera.set_all(value)
        self.front_camera_0.set_all(value)
    ...
    def set_all_low_dim(self, value: bool):
        ...
        self.joint_velocities_2 = value
        self.joint_positions_2 = value
        self.joint_forces_2 = value
        self.gripper_open_2 = value
        self.gripper_pose_2 = value
        self.gripper_matrix_2 = value
        self.gripper_joint_positions_2 = value
        self.gripper_touch_forces_2 = value
