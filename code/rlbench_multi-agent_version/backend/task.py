...
class Task(object):
    ...
    def __init__(self, pyrep: PyRep, robot: Robot, robot_2: Robot, name: str = None):
        """Constructor.
        ...
        self._waypoint_abilities_start_robot_2 = {}
        self._waypoint_abilities_end_robot_2 = {}
        self._waypoints_should_repeat = lambda: False
        self._waypoints_should_repeat_robot_2 = lambda: False
    ...
    def boundary_root(self) -> Object:
        ...
        :return: The PyRep Object that will act as the root.from typing import List
...
class TakeLidOffSaucepan(Task):
    ...
    def register_waypoint_ability_start_robot_2(self, waypoint_index: int,
                                        func: Callable[[Waypoint], None]):
        """Register a function to be called before moving to waypoint.
        ...
        :param func: A function that takes a Waypoint object.
        """
        self._waypoint_abilities_start_robot_2[waypoint_index] = func

    def register_waypoint_ability_end_robot_2(self, waypoint_index: int,
                                        func: Callable[[Waypoint], None]):
        """Register a function to be called after moving to waypoint.
        ...
        :param func: A function that takes a Waypoint object.
        """
        self._waypoint_abilities_end_robot_2[waypoint_index] = func

    def register_waypoints_should_repeat_robot_2(self, func: Callable[[], bool]):
        """Register a function that is called when reached the end of a demo.
        ...
        :param func: A function that return a bool if the demo should repeat.
        """
        print ("checking the end function: ", func)
        self._waypoints_should_repeat_robot_2 = func
    ...
    def _feasible_robot_2(self, waypoints: List[Point]) -> Tuple[bool, int]:
        # print ("Are we checking feasibility?")
        arm = self.robot_2.arm
        start_vals = arm.get_joint_positions()
        for i, point in enumerate(waypoints):
            path = None
            try:
